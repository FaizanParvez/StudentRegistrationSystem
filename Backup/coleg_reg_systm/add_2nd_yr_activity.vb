...
Public Class add_2nd_yr_activity
    ...
    Private Sub add_2nd_yr_activity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txt_admission_no.Text = coleg_main_form.add_2nd_yr_act_num
        ...
        Dim CMD1 As New SqlCommand("select admission_no from activity_sec_yr where admission_no=@txt_admission_no", CN)
        ...
        Try
            ...
            If DR1.Read = True Then
                MessageBox.Show("2ND YEAR Student activities already added", "ERROR...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.Close()
                If CN.State = ConnectionState.Open Then CN.Close()
            End If
            CN.Close()
    ...
    Private Sub btn_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_save.Click
        ...
        Dim CMD As New SqlCommand("insert into activity_sec_yr (admission_no,cross_country , ath_games,camps_mount,debate,swimming,quiz) values (   @txt_admission_no,@cmb_cross_country , @cmb_ath_games,@cmb_camps_mount,@cmb_debate,@cmb_swimming,@cmb_quiz)", CN)
        ...
        Try
            ...
            CMD.ExecuteNonQuery()
            CN.Close()
            MessageBox.Show("2ND YEAR Student activities added sucessfully", "2ND YEAR ACTIVITIES...", MessageBoxButtons.OK, MessageBoxIcon.Information)
