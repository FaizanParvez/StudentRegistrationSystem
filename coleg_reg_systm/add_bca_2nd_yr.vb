...
Public Class add_bca_2nd_yr
    ...
    Private Sub add_bca_2nd_yr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim CMD1 As New SqlCommand("select admission_no from second_year where admission_no=@txt_admission_no", CN)
        ...
        Try
            ...
            Else
                MessageBox.Show("Student yet not enrolled to ist year", "2ND YEAR ADMISSION...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.Close()
                If CN.State = ConnectionState.Open Then CN.Close()
            End If
            CN.Close()
    ...
    Private Sub btn_next_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_next.Click
        add_2nd_yr_fee_detail.ShowDialog()
        add_2nd_yr_fee_detail.txt_paid_fee.Focus()
