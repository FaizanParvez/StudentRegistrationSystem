...
Public Class view_stud_3rd_yr_activity
    ...
    Private Sub view_stud_3rd_yr_activity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If flag = False Then
            ...
            txt_admission_no.Text = coleg_main_form.view_stud_3rd_yr_act_num
