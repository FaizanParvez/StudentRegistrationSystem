...
Public Class edit_stud_2nd_yr_activity
    ...
    Private Sub edit_stud_2nd_yr_activity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If flag = False Then
            ...
            txt_admission_no.Text = coleg_main_form.edit_stud_2nd_yr_act_num
...
amir:
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        ...
        Dim CMD As New SqlCommand("update activity_sec_yr set admission_no =  @txt_admission_no,cross_country=@cmb_cross_country ,    ath_games  =   @cmb_ath_games,camps_mount=@cmb_camps_mount,debate=@cmb_debate,swimming=@cmb_swimming,quiz=@cmb_quiz where admission_no=@txt_admission_no", CN)
        txt_admission_no.Text = coleg_main_form.edit_stud_2nd_yr_act_num
        ...
        Try
            ...
            CMD.ExecuteNonQuery()
            CN.Close()
            MessageBox.Show("2nd year Student activities updated sucessfully", "STUDENT ACTIVITIES...", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.Close()
