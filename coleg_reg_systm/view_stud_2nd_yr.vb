...
Public Class view_stud_2nd_yr

    '******************** CREATING CONNECTION ****************

    Dim CN As New SqlConnection("server=FAIZAN-PC\SQLSERVER05;initial catalog=student_registration;integrated security=true")

    Private Sub view_stud_2nd_yr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txt_admission_no.Text = coleg_main_form.view_stud_2nd_yr_num
