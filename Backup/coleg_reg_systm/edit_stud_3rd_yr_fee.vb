...
Public Class edit_stud_3rd_yr_fee
    ...
    Private Sub edit_stud_3rd_yr_fee_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim CMD As New SqlCommand("select admission_no,joining_class , ist_name , last_name ,fathers_name, session,balance from final_year where admission_no=@txt_admission_no", CN)

        txt_admission_no.Text = coleg_main_form.edit_stud_3rd_yr_fee_num
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        ...
        Dim CMD As New SqlCommand("update final_year set balance=@balance where admission_no=@msk_admission_no", CN)
        txt_admission_no.Text = coleg_main_form.edit_stud_3rd_yr_fee_num
