...
Public Class edit_stud_3rd_yr_detail

    Dim flag As Boolean = False

    Dim CN As New SqlConnection("server=AMIRRESHI-PC\SQLSERVER05;initial catalog=Coleg_RS;integrated security=true")

    Private Sub edit_stud_3rd_yr_detail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        cmb_joining_class.SelectedIndex = 2
        txt_exam_passed.Text = "2ND YEAR"
        ...
        txt_admission_no.Text = coleg_main_form.edit_stud_3rd_yr_num
        ...
        Try
            ...
            Else
                MessageBox.Show("Student yet not enrolled to 3rd year", "UPDATE 2ND YEAR ADMISSION...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.Close()
                If CN.State = ConnectionState.Open Then CN.Close()
            End If
            CN.Close()
    ...
    Private Sub btn_pic_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pic.Click
        ...
        If OpenFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            Dim cmd As New SqlCommand("select picture from final_year where admission_no <> @msk_admission_no", CN)
