...
Public Class edit_stud_details_form
    ...
    '******************** STUDENT DETAILS FORM LOAD ****************

    Private Sub edit_stud_details_form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim CMD As New SqlCommand("select admission_no,joining_class , ist_name , last_name ,fathers_name , mothers_name, d_o_b, cell_no , exam_passed,session,sex , address ,state ,city , email_id,pin_no,picture from admission where admission_no=@msk_admission_no", CN)

        txt_admission_no.Text = coleg_main_form.edit_stud_det_num
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        If flag = False Then
            ...
            CMD.Parameters.AddWithValue("@txt_email", txt_email.Text)
    ...
    Private Sub txt_student_last_name_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_student_last_name.TextChanged
    ...
    Private Sub txt_fathers_name_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_fathers_name.TextChanged
    ...
    Private Sub btn_pic_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pic.Click
        ...
        If OpenFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            Dim cmd As New SqlCommand("select picture from admission where admission_no <> @msk_admission_no", CN)
